...
public class Utility {
    ...
    public static final String PREFERENCES_NAME = "SunshinePreferences";
...
//                = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static Bitmap getBitmap(int resourceId, Context context) {
